...
public class WatchmanActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
...
//
    ...
    public boolean onOptionsItemSelected(MenuItem item){
        ...
        if(id==R.id.action_logout){
            ...
            Intent launch_logout=new Intent(WatchmanActivity.this,MainActivity.class);
